...
- **4D tensor**: 特别是在图像处理中, 4D 张量非常常见, 现在单独详细研究一下它:
    ...
    - **描述顺序和内存中的布局**[^data-layout]: (注意无论多少维度的张量, 在内存中显然都是以 (也只能以) 一维数组的形式连续存储).
        ...
        ![三种 Data Layout Formats @a2023_understanding.](tensor-layout.png){#fig-tensor-layout width=80%}
...
- **所有 Tensor 形状变化构成群, 可由下面三个生成元 (Grouping, Transposition, Concatenation) 生成**:
    ...
    ![Tensor 变形的三个生成元.](tensor-generator.png){#fig-tensor-generator width=50%}
