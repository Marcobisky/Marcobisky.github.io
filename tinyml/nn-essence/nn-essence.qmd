...
(FCNN, CNN, Transformer是同一层面上的概念? ["Differential Model"](https://distill.pub/2021/gnn-intro/#graph-to-tensor) 我感觉 FCNN 和 CNN 的本质是一样的? CNN 的本质是 pre-trained FCNN (或者说尊重了 $\mathcal{X}$ 结构?))
