...
- **2025-07-08**: 喜提新 Thinkbook, 由于显卡和网卡驱动找不到安装 Debian 失败特别狂躁, Tonic 上报复性狂练 3 小时降 E 大调音阶. 后来安装 Ubuntu 24.04 实体机成功编译. btw, [Spark](xqark.github.io) 推荐的 AtlasOS 太好用啦, [Synergy](https://symless.com/synergy) 同步 Win, Mac, IOS, Linux 剪切板太方便啦 (就是没有安卓hh)
