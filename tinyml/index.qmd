...
gantt
    ...
    section Project
        ...
        Coral NPU :active, 2025-12-28, 2026-02-16
        Interim :milestone, 2026-01-15, 0d
        FPGA :milestone, 2026-02-15, 0d
    ...
    section Learn
        ...
        GPU Arch :active, 2026-01-15, 2026-02-15
...
|----------------------------|---|----------|
| **2026-02-16~03-22** | Learn | 申请学校, 深入学习 LLM 和 RL (Diffusion, FM), etc. |
| **2026-02-13~15** | Project | 成功将 naive 向量加法的 NPU 硬件和 C runtime 烧录到 `xc7a100tcsg324-1` 上并测试成功, 好开心!!! |
