...
- **Bin**: 仅仅是为了**方便计算**布局的密度 @_2024_83 (类似有限元方法), 整个 die 被划分为若干个小的矩形区域 (厚度跟 die 的厚度一样), 每个小区域称为一个 bin @zhao2024analyticalheterogeneousdietodie3d (见 @fig-bindemo). 所有的 bin 组成的集合记作 $B$.
...
- [**iEDA** 资料](https://ieda.oscc.cc/train/eda/eda-model/8_3_palcement.html) @_2024_83.
