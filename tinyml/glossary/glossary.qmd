...
- **3D IC** 常见类型:
    - **TSV-based**: 用 **TSV (Through-Silicon Via) 硅通孔**, 就是在硅片上打孔, 然后在孔内镀铜, 形成垂直的电连接通道. 但由于 large pitches and parasitics, 性能提升有限 @zhao2024analyticalheterogeneousdietodie3d.
    - **Monolithic**: 一整块硅片上制造多个层次的电路, 成本高.
    - **F2F (Face-to-Face)**: 用 **HBT (Hybrid bonding terminal)** 端子连接上下层 Die (通过直接原子键合) @zhao2024analyticalheterogeneousdietodie3d.
