...
description: A concise introduction to electromagnetics.
date: 2025-2-25
# image: cover.png
categories:
    - Physics
...
2. Two parallel wires attract or repel each other when current is applied.
