  ...
  pdf:
    include-in-header:
      text: |
        ...
        \geometry{left=0.9cm, top=0.9cm, right=0.7cm, bottom=1cm}
    include-before-body:
      text: |
        \noindent
        \parbox{4.5cm}{
...
**A Study of Generalized Fields and Extension to Higher Dimensions** [(*Oct 2023 --- Feb 2024*)]{.cvdate}
...
- Largely motivated by my tutor Mr. [Yidong Liu](https://www.sp.uestc.edu.cn/info/1054/1386.htm) and my friends and complete by myself.
...
- **Math**: Self learned ([Abstract Algebra (Harvard E-222)](http://wayback.archive-it.org/3671/20150528171650/https://www.extension.harvard.edu/open-learning-initiative/abstract-algebra)), [Point-set Topology](https://www.math.toronto.edu/ivan/mat327/?resources), [Real Analysis](https://www.amazon.sg/Principles-Mathematical-Analysis-Walter-Rudin/dp/9355325967), [Complex Analysis (MIT 18.04)](https://ocw.mit.edu/courses/18-04-complex-variables-with-applications-spring-2018/), [Functional Analysis](https://books.google.com.sg/books/about/Functional_Analysis.html?id=LzgqBAAAQBAJ&source=kp_cover&redir_esc=y), Elementary [Differential Geometry](https://www.amazon.sg/Visual-Introduction-Differential-Calculus-Manifolds/dp/3319969919), [Smooth Manifolds](https://www.amazon.sg/dp/1441973990?ref_=mr_referred_us_sg_sg) (*still learning*). I'm relatively comfortable using these languages.
