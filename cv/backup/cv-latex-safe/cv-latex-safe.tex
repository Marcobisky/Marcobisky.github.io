...
\begin{itemize}
    ...
    \item \textbf{Major}: Communication Engineering; GPA: 3.87/4.0, Ranking: 2/164 (Top 1.2\%).
    \item \textbf{Relevant Coursework}: Signals and Systems, Stochastic Processes, Information Theory, Electrodynamics, Digital Circuit Design, etc.
...
% \begin{itemize}
%     \setlength\itemsep{-0.5em}
%     \item Designing, implementing and verifying hardware-accelerated DSC and attention kernels in ViT using \texttt{C++} with RVV intrinsics that are adaptable and efficient for edge computing in \MYhref{https://github.com/google-coral/coralnpu/tree/main}{Coral NPU} framework open-sourced by Google and VeriSilicon. 
...
\textbf{YOPO: You Only Pick Once -- Light Object Tracking Algorithm} \hfill Sept 2025
...
\textbf{Design and Visualization of a Complete Single-cycle RV32I CPU Core} \hfill Jan 2025 --- Mar 2025
...
\textbf{Generalized Fields and Extension to Higher Dimensions} \hfill Oct 2023 --- Feb 2024

\vspace{-0.5em} \begin{small} \textit{Research Assistant, \MYhref{https://en.uestc.edu.cn/info/1074/3699.htm}{Professor Yidong Liu}, UESTC} \end{small} \vspace{-0.5em}

\begin{itemize}
    \setlength\itemsep{-0.5em}
    \item Investigated generalized natural fields and behaviors in higher dimensions.
