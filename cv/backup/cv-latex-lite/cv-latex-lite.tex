...
\MYhref{https://marcobisky.github.io/tinyml/}{\textbf{System-level Co-Design of RISCV Accelerators for TinyML at the Edge}} \hfill Ongoing
...
\begin{itemize}
    \setlength\itemsep{-0.5em}
    \item Designing, implementing and verifying hardware-accelerated depthwise-seperable convolution (DSC) and attention kernels in ViT using \texttt{C++} with RVV intrinsics that are adaptable and efficient for edge computing in \MYhref{https://github.com/google-coral/coralnpu/tree/main}{Coral NPU} framework open-sourced by Google and VeriSilicon. 
    \item Exploring CUDA-like DSL to RVV ISA compiler for seamless deployment of TinyML models on RISCV-based NPUs.
...
% \textbf{GAT-based Multi-Task RL for Robust PVT-Aware Analog Design} \hfill Aug 2025 --- Oct 2025
...
% \MYhref{https://marcobisky.github.io/cv/physics-paper.pdf}{\textbf{Generalized Fields and Extension to Higher Dimensions}} \hfill Oct 2023 --- Feb 2024
...
\begin{itemize}
    \setlength\itemsep{-0.5em}
    \item Designed and open-sourced an single-core, single-cycle RISCV 32-bit CPU from scratch in \texttt{Verilog} for RTL simulation and in \texttt{Digital} Software for working principle visualization. 
...
\begin{itemize}
    \setlength\itemsep{-0.5em}
    \item Integrated a convolutional neural network (CNN) into STM32 MCU using \texttt{C} in \texttt{MbedOS}.
...
\textbf{IT Skills} &  \normalsize{Latex, Quarto Markdown, Typst, \MYhref{https://www.bilibili.com/video/BV1AterevErt/?spm_id_from=333.1387.homepage.video_card.click&vd_source=42579e22289b6144ba0b2bdcf99834e3}{Manim}, \MYhref{https://github.com/Marcobisky}{Github}.}\\
