...
![Geometric proof of @lem-determinant](determinant-geometric.png){#fig-determinant-geometric}
...
\end{vmatrix}
$$
because the result $v \times w = (v_2w_3 - v_3w_2)\hat{\imath} + (v_3w_1 - v_1w_3)\hat{\jmath} + (v_1w_2 - v_2w_1)\hat{k}$ is very much like a dot product!
...
The dimension of the vector space of $k$-tensors on $\mathbb{R}^n$[^volume] is ${n \choose k}$:
$$
...
As a special case when $n = k = 3$, we have:
$$
\boxed{
