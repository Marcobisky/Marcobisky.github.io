...
description: Symmetry is group action!
date: 2025-3-3
image: cover.png
categories:
    - Algebra
...
$$
for all permutations $\sigma \in S_k$; it is ***alternating*** iff
$$
...
Though generally we cannot decompose an arbitrary tensor into a symmetric and alternating part, we could build them by any tensors:
...
Let $\phi \in \operatorname{Hom} (\mathbb{C}^{n \times n})$, derive the definition of $S\phi$ and $A \phi$.
:::
