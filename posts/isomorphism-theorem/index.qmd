---
author: Marcobisky
title: Understanding Isomorphism Theorems for Groups
...
**Prerequisites**: *Quotient group, group homomorphism, normal subgroup, at least 5 examples of groups, basic category theory*.
...
- The first isomorphism theorem: Universal property of quotients.
- The second isomorphism theorem: How subgroups behave under projections.
- The third isomorphism theorem: Just a diagram commutes.
...
::: {#def-kernel-is-normal .callout-def}
...
::: {#def-normal-is-kernel .callout-def}
