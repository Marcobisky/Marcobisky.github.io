...
draft: true
author: Marcobisky
title: Complement for 3b1b's Diffusion Models Video
...
- 训练范式的思考过程:
    - 直接在 @fig-image-space (@fig-image-space) 中**梯度上升**找到有意义的图像. 但如何知道概率标量场 / 梯度场 ("Score function" @DBLP:journals/corr/abs-2011-13456) 呢?
