---
author: Marcobisky
title: "Q&A: Why $e_i$ is exactly the same as $\\frac{\\partial}{\\partial x^i}$?"
description: Basis vectors are exactly the same as partial derivative operator?
date: 2025-03-04
image: cover.png
categories:
...
In a general manifold $M$, the concept of *derivations* remain while *vectors* is hard to define. So we will actually use derivations to define ***tangent vector*** in a manifold[^tubook]:
